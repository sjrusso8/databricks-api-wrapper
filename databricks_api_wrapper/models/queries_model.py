...
#   filename:  queries-dashboards-2.0-azure.yaml
#   timestamp: 2022-05-14T13:15:34+00:00
...
class ObjectTypeAndId(BaseModel):
    __root__: str = Field(
        ...,
...
class QueryIntervalObject(BaseModel):
...
class ParameterObject(BaseModel):
    ...
    type: Optional[Type] = Field(
        None, description='Parameters can have several different types.'
    )
...
class DropdownParameterValue(BaseModel):
    name: Optional[str] = Field(
        None,
        description='The name of this parameter that appears between curly braces in the query definition.',
    )
...
class DateParameterValue(BaseModel):
    name: Optional[str] = Field(
        None,
        description='The name of this parameter that appears between curly braces in the query definition.',
    )
...
class QueryObject(BaseModel):
    id: Optional[str] = Field(None, example='dee5cca8-1c79-4b5e-a711-e7f9d241bdf6')
    latest_query_data_id: Optional[str] = Field(
        None,
    ...
    is_favorite: Optional[bool] = Field(
        None,
        description="Whether this query object appears in the current user's favorites list. This flag determines whether the star icon for favorites is colored in.",
        example=True,
    )
...
class QueryPostContent(BaseModel):
    data_source_id: Optional[Any] = Field(
        None,
...
class QueryResultColumnDescription(BaseModel):
    name: Optional[str] = None
    friendly_name: Optional[str] = None
    type: Optional[str] = None


class QueryResultRowDescription(BaseModel):
    pass
...
class Options2(BaseModel):
    parameterMappings: Optional[Dict[str, Any]] = Field(
        None,
